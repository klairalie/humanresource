...
// // 🔵 HR Only
// Route::middleware(['web', CheckAuth::class, 'position:HHuman Resource Manager'])->group(function () {
...
// // 🟡 Shared (Admin + HR)
// Route::middleware(['web', CheckAuth::class, 'position:Human Resource Manager, Administrative Manager'])->group(function () {
//     Route::get('/HR', [DashboardController::class, 'dashboard']);
//     Route::get('/Employeeprofiles', [EmployeeprofilesController::class, 'showEmployeeprofiles']);
//     Route::get('/archivedprofiles/login', [ArchivedprofilesController::class, 'loginForm']);
//     Route::get('/assessmentresult', [AssessmentResultController::class, 'showAssessmentResults']);
//     Route::get('/evaluateservices', [EvaluateServicesController::class, 'showEvaluateServices'])->name('show.evaluateservices');
//     Route::get('/archivedprofiles', [ArchivedprofilesController::class, 'showArchivedProfiles'])->name('archived.profiles');
...
//     Route::get('/export-services', [ServiceController::class, 'exportServices'])->name('services.export');
// });
